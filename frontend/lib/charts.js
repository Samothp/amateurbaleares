...
export const DynamicBarChart = dynamic(() => import('recharts').then((m) => m.BarChart), {
  ssr: false,
...
export const DynamicPieChart = dynamic(() => import('recharts').then((m) => m.PieChart), {
  ssr: false,
...
export const DynamicRadarChart = dynamic(() => import('recharts').then((m) => m.RadarChart), {
  ssr: false,
  loading: () => <div style={{ height: 280, background: '#f8f9fa', borderRadius: 8 }} />,
});
...
export const DynamicLineChart = dynamic(() => import('recharts').then((m) => m.LineChart), {
  ssr: false,
  loading: () => <div style={{ height: 250, background: '#f8f9fa', borderRadius: 8 }} />,
});
...
export const PolarRadiusAxis = dynamic(() => import('recharts').then((m) => m.PolarRadiusAxis), {
  ssr: false,
});
